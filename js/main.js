...
function addBereich(params) {
  ...
  let slidercont = `<h2>${parentdiv.dataset.name}: <span class="Beschreibung"></span></h2><div class="container d-flex justify-content-around"><div class="m-2 ml-0"><canvas class="ZZZRegler" id="regler" width="50" height="200" data-count="0"data-color="#34A056"></canvas><h5 class="Zufriedenheitsfaktor1"></h5></div><div class="m-2"><canvas class="ZZZRegler" id="regler" width="50" height="200" data-count="0"data-color="#34A056"></canvas><h5 class="Zufriedenheitsfaktor2"></h5></div><div class="m-2 mr-0"><canvas class="ZZZRegler" id="regler" width="50" height="200" data-count="0"data-color="#34A056"></canvas><h5 class="Zufriedenheitsfaktor3"></h5></div></div>`;
